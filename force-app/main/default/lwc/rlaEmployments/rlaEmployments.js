...
import getEmploymentRecords from "@salesforce/apex/RlaLWCsHelper.getRlaEmploymentRecords";
...
import JOBTITLE_FIELD from "@salesforce/schema/LoanApplicantEmployment.JobTitle";
...
const COLUMNS = [
    ...
    {
        label: 'Job Title or Type of Business',
        fieldName: JOBTITLE_FIELD.fieldApiName,
        type: 'text',
        sortable: true,
        typeAttributes: {label: { fieldName: 'JobTitle' }}
    },
    {
...
export default class LoanApplicantEmployments extends NavigationMixin(LightningElement) {
    ...
    @wire (getEmploymentRecords, {loanApplicationId: "$recordId", pickList: "$employmentTypePicklistValues", pickList: "$frequencyPicklistValues", pickList: "$incomeTypePicklistValues" } )
