...
import getIncomeRecords from "@salesforce/apex/RlaLWCsHelper.getRlaIncomeRecords";
...
export default class LoanApplicantEmployments extends NavigationMixin(LightningElement) {
    ...
    @wire (getIncomeRecords, {loanApplicationId: "$recordId", pickList: "$incomeSourceTypePickListValues"} )
